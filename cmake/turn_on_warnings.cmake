...
macro(add_cxx_compiler_flag_if_supported flag)
  ...
  if(flag_supported)
    list(APPEND VT_LB_WARNING_FLAGS "${flag}")
  endif()
  unset(flag_supported CACHE)
endmacro()

if(NOT DEFINED VT_LB_WARNING_FLAGS)
  ...
  if (VT_LB_WERROR_ENABLED)   # Treat warning as errors
    add_cxx_compiler_flag_if_supported("-Werror")
  endif()
endif()

set(
  VT_LB_WARNING_FLAGS ${VT_LB_WARNING_FLAGS} CACHE INTERNAL
  "Project's warning options")

macro(turn_on_warnings vt_tv_target)
  target_compile_options(${vt_tv_target} PRIVATE ${VT_LB_WARNING_FLAGS})
endmacro()
